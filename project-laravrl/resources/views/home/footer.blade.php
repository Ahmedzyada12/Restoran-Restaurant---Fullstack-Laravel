    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>100 Street, Cairo, Mansoura</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+012 345 67890</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>azyada299@gmail.com</p>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <p>09AM - 12PM</p>
                <h5 class="text-light fw-normal">Fraiday</h5>
                <p>11AM - 03AM</p>
            </div>
